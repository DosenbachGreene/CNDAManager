...
@app.get("/download/status/{download_job_id}")
...
def downloading_queue(download_job_id: UUID, project_id: str, subject_ids: List[str]):
    ...
    with ThreadPoolExecutor(max_workers=5) as executor:
        ...
        download_futures = {executor.submit(downloader, download_job_id, project_id, subject): subject for subject in subject_ids}
